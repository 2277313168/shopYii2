        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                    <img class="img-responsive" alt="" width="120px" height="120px" src="<?php echo 'http://ommrvw8iv.bkt.clouddn.com/'.$goods['goods_img'] ?>" data-echo="assets/images/products/product-gallery-01.jpg" />
                </a>
...
<!--        <div class="availability"><label>Availability:</label><span class="available">  in stock</span></div>-->
        ...
        <div class="title"><a href="#"><?php echo $goods['goods_name'] ?></a></div>
<!--        <div class="brand">sony</div>-->
        ...
        <div class="prices">
            <div class="price-current"><?php echo $goods['shop_price'] ?></div>
            <div class="price-prev"><?php echo $goods['promote_price'] ?></div>
        </div>
        <div class="prices">
            <div ><?php echo '库存：'.$goods['goods_number'] ?></div>
...
<!--            <a id="addto-cart" href="cart.html" class="le-button huge">加入购物车</a>-->
            <input type="submit"  class="le-button huge" value="加入购物车" />
            <input type="hidden" name = 'goods_id' value="<?php echo $goods['goods_id']?>">
            <input type="hidden" name = 'goods_num' value="1">
            <input type="hidden" name = 'goods_attr_id' value="1">
<?php ActiveForm::end() ?>
