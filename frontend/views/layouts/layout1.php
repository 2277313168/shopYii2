    ...
    <nav class="top-bar animate-dropdown">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul>
                    <li><a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">Home</a></li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php yii\helpers\Url::to(['cart/index']) ?>">去购物车结算</a></li>
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul class="right">
                    ...
                    <?php if(Yii::$app->session['user_id']): ?>
                        <li>您好，<?php echo Yii::$app->session['user_name'] ?></li>
                        <li><a href="<?php echo yii\helpers\Url::to(['user/logout']) ?>">退出</a></li>
                   <?php else: ?>
                        <li><a href="<?php echo yii\helpers\Url::to(['user/register']) ?>">Register</a></li>
                        <li><a href="<?php echo yii\helpers\Url::to(['user/login']) ?>">Login</a></li>
                    <?php endif; ?>
                </ul>
            </div><!-- /.col -->
        </div><!-- /.container -->
