                ...
                <nav class="yamm megamenu-horizontal" role="navigation">
                    <ul class="nav">
                        ...
                        <li class="dropdown menu-item">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $v['cat_name'] ?></a>
    ...
    <div class="container">
        <div class="tab-holder">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#featured" data-toggle="tab">新品榜</a></li>
                <li><a href="#new-arrivals" data-toggle="tab">促销榜</a></li>
                <li><a href="#top-sales" data-toggle="tab">推荐榜</a></li>
            </ul>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="featured">
                    <div class="product-grid-holder">
                        ...
                        <?php foreach($onsale as $k=>$v): ?>
                            <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                                <div class="product-item">

                                    <div class="ribbon red"><span>sale</span></div>
                                    <div class="image">
                                        <img alt="" src="<?php echo 'http://ommrvw8iv.bkt.clouddn.com/'.$v->goods_img; ?> " width="190px" height="190px"
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="title">
                                            <a href="<?php echo yii\helpers\Url::to(['goods/detail','id'=>$v['goods_id']]) ?>"><?php echo $v['goods_name']; ?></a>
                                        </div>
                                        <div class="brand">sony</div>
                                    </div>
                                    <div class="prices">
                                        <div class="price-prev"><?php echo $v['shop_price']; ?></div>
                    ...
                    <div class="product-grid-holder">
                        ...
                        <div class="col-sm-4 col-md-3 no-margin product-item-holder hover">
                            <div class="product-item">
                                ...
                                <div class="ribbon red"><span>sale</span></div>
                                <div class="image">
                                    <img alt="" src="<?php echo 'http://ommrvw8iv.bkt.clouddn.com/'.$v->goods_img; ?>"
                                         data-echo="assets/images/products/product-01.jpg"/>
                                </div>
                                ...
                                <div class="body">
                                    <div class="label-discount green">-50% sale</div>
                                    <div class="title">
                                        <a href="single-product.html"><?php echo $v['goods_name']; ?></a>
                                    </div>
                                    <div class="brand">sony</div>
                                </div>
                                <div class="prices">
