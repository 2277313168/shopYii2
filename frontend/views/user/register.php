...
<!--					</div>-->
                    ...
                    <?php  $form = ActiveForm::begin(
                        ['fieldConfig'=>['template'=>'<div class="field-row">{input}</div>{error}' ]],
                        ['option' => ['class'=> "login-form cf-style-1"] ]
                    ); ?>
<!--					<form role="form" class="login-form cf-style-1">-->

                    <label>邮箱</label>
                    <?php echo $form->field($model, 'email')->textInput(['class' => 'le-input']); ?>

                    <label>密码</label>
                   <?php echo $form->field($model, 'password')->textInput(['type'=>'password','class' => 'le-input']); ?>
...
<!--                            <button type="submit" class="le-button huge">登录</button>-->
                        </div>
                    <!-- /.buttons-holder -->
<!--					</form>-->
