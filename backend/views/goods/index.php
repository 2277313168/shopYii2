            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <?php foreach ($goodsList as $v): ?>
                        <tr class="first">
                            <td>
                                <img src="<?php echo 'http://ommrvw8iv.bkt.clouddn.com/'.$v->goods_img; ?>-_logo"
                                     class="img-circle avatar hidden-phone"/>
                                <a href="#" class="name"><?php echo $v->goods_name; ?></a>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php $hot = ['不热卖', '热卖'] ?>
                                <?php echo $hot[$v->is_hot]; ?>
                            </td>
                            <td>
                                <?php $sale = ['不促销', '促销'] ?>
                                <?php echo $sale[$v->is_promote]; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php $on = ['下架', '上架'] ?>
                                <?php echo $on[$v->is_onsale]; ?>
                            </td>
                            <td>
                                <?php $on = ['非新品', '新品'] ?>
                                <?php echo $on[$v->is_new]; ?>
                            </td>

                            <td class="align-right">
                                <a href="<?php echo yii\helpers\Url::to(['goods/edit','id'=>$v['goods_id']]) ?>">编辑</a>
                                <a href="<?php echo yii\helpers\Url::to(['goods/delete','id'=>$v['goods_id']]) ?>">删除</a>
