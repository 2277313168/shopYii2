...
<div class="row-fluid login-wrapper">
    ...
    <div class="span4 box">
        <div class="content-wrap">
            <h6>慕课商城 - 后台管理</h6>
            <?php echo $form->field($admin, 'admin_name')->textInput(["class" => "span12", "type" => "text", "placeholder" => "管理员账号"]); ?>
            <?php echo $form->field($admin, 'password')->textInput(["class" => "span12", "type" => "password", "placeholder" => "管理员密码"]); ?>
            <!--                <input class="span12" type="text" placeholder="管理员账号" />-->
            <!--                <input class="span12" type="password" placeholder="管理员密码" />-->
            <a href="<?php echo yii\helpers\Url::to(['login/seekpsw']) ?>" class="forgot">忘记密码?</a>

            <?php echo $form->field($admin, 'rememberMe')->checkbox(["id" => "remember-me",
